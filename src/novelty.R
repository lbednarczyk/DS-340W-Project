...
# Creating clusters of male and female
...
# Compare results between sex clusters
femalemodel$overall
malemodel$overall


# Creating age clusters: under 55 and 55 and older
under55 <- subset(data, age < 55)
...
# Compare results between age clusters
under55model$overall
above55model$overall
